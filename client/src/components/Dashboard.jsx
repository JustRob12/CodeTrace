...
const Dashboard = () => {
    ...
    const fetchStudentCounts = async () => {
        try {
            ...
            const total =
                counts.firstYear + counts.secondYear + counts.thirdYear + counts.fourthYear;
        ...
        <div className="flex min-h-screen">
            <div className="flex-1 p-8 bg-gray-100">
                ...
                <p className="text-gray-600 mb-6">
                    Select a section from the sidebar to manage students, events, attendance, and calendar.
                </p>
                        ...
                        <div className="grid grid-cols-2 gap-4 flex-1">
                            <div className="bg-blue-500 text-white p-4 rounded-lg shadow-lg flex items-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-3xl font-bold">
                                        <CountUp start={0} end={studentCounts.firstYear} duration={1.5} />
                                    </p>
                                </div>
                            </div>
                            <div className="bg-green-500 text-white p-4 rounded-lg shadow-lg flex items-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-3xl font-bold">
                                        <CountUp start={0} end={studentCounts.secondYear} duration={1.5} />
                                    </p>
                                </div>
                            </div>
                            <div className="bg-yellow-500 text-white p-4 rounded-lg shadow-lg flex items-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-3xl font-bold">
                                        <CountUp start={0} end={studentCounts.thirdYear} duration={1.5} />
                                    </p>
                                </div>
                            </div>
                            <div className="bg-red-500 text-white p-4 rounded-lg shadow-lg flex items-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-3xl font-bold">
                                        <CountUp start={0} end={studentCounts.fourthYear} duration={1.5} />
                                    </p>
                                </div>
                            </div>
                        </div>
